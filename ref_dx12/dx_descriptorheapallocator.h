...
namespace DescriptorHeapUtils
{
	...
	D3D12_UNORDERED_ACCESS_VIEW_DESC GetUAVBufferNullDescription();
	
	D3D12_SHADER_RESOURCE_VIEW_DESC GenerateDefaultStructuredBufferSRVDesc(Resource* buffer, int stride);
	D3D12_UNORDERED_ACCESS_VIEW_DESC GenerateDefaultStructuredBufferUAVDesc(Resource* buffer, int stride);
}